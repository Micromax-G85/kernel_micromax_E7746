...
function zupload()
{
git clone --depth=1 https://github.com/sarthakroy2002/AnyKernel3.git -b E7746 AnyKernel
cp out/arch/arm64/boot/Image.gz-dtb AnyKernel
cd AnyKernel
nano anykernel.sh
zip -r9 StormBreaker-r1.0-E7746.zip *
curl -sL https://git.io/file-transfer | sh
./transfer wet StormBreaker-r1.0-E7746.zip
}
